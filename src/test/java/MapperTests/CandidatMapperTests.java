...
public class CandidatMapperTests {
    ...
    private static UUID uuidCandidat = UUID.randomUUID();
    private static UUID uuidcandidatDto = UUID.randomUUID();
    ...
    public static void  setup() {
        ...
        creneauxDto.add(new CreneauDto(uuidCreneauDto, "date", "10", "11"));
